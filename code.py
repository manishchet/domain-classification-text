...
c = tfidfVectorizer.fit(all_text)
X = c.transform(all_text)
labelencoder  = LabelEncoder()
z = labelencoder.fit(df['category'])
y = z.transform(df['category'])
...
lsvm_accuracy_2 = accuracy_score(y_pred_lsvm,y_test)
y_pred_nb = nb.predict(X_test)
nb_accuracy_2 = accuracy_score(y_pred_nb,y_test)
